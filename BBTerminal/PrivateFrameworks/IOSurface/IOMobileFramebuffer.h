...
IOMobileFramebufferReturn IOMobileFramebufferGetID(
                                                   IOMobileFramebufferService *connect,
                                                   CFTypeID *id );
IOMobileFramebufferReturn IOMobileFramebufferGetLayerDefaultSurface(io_connect_t connect, uint32_t type, void* surfaceBuffer);

IOMobileFramebufferReturn IOMobileFramebufferGetDisplaySize(io_connect_t connect, CGSize *t);
