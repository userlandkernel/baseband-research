...
typedef enum QcdmRuimConfigType {
...
typedef qcdm_req_header_t qcdm_generic_req_t;

PACKED(typedef struct QcdmPhoneModeRequest{
	uint8_t command;
	uint8_t mode;
	uint8_t padding;
}) qcdm_phone_mode_req_t;
