...
/* Add unchecked fixture setup/teardown functions to a test case
   ...
   Also, when run in CK_NOFORK or CK_WITHPARTNER mode, unchecked fixture functions may
...
/* Add fixture setup/teardown functions to a test case
   ...
   CK_FORK, CK_WITHPAGER and CK_NOFORK modes.
